...
def run_main(args):
    ...
    if(args.drop_rate == 0.0):#gai
        ...
        #
        df_impute_all.to_csv('./save/result/' + sc_data_name + '/cbam_impute_all_leiden_' +sc_data_name+'.csv') #gai
        ...
        df_impute_all.to_csv('./save/result/' + sc_data_name + '/cbam_impute_all_drop_'+str(args.drop_rate)+ '_leiden_' + sc_data_name + '.csv')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=600, help='Number of epoches training. Default: 500')
    ...
    parser.add_argument('--lr', type=float, default=0.000001,help='Learning rate of model training. Default: 1e-2')
    parser.add_argument('--batch_size', type=int, default=512,help='Number of batch size when training. Default: 200')
    ...
    # run_main(args)
    drop_rates = [0.0]
    # 'GSE112274', 'GSE117872','GSE134836',
    # sc_data_folder_name = ['GSE112274', 'GSE117872', 'GSE134836', 'GSE134838', 'GSE134839', 'GSE134841', 'GSE140440',
    #                  'GSE149214', 'GSE81861', 'GSM3618014']
    sc_data_folder_name = ['GSE134838']
    for data_name in sc_data_folder_name:
        args.data_name = data_name
        print("____________________________________", args.data_name, "________________________________")
        for temp_drop_rate in drop_rates:
